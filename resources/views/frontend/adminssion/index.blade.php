...
<!-- Mirrored from itcareerinstitute.org/index.php/form/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jun 2023 17:44:07 GMT -->
<!-- Added by HTTrack -->
...
<head itemscope="" itemtype="http://schema.org/WebSite">
    ...
    <title>STUDENT ADMISSION &#8211; IT CAREER INSTITUTE</title>
    ...
    <link rel="alternate" type="application/json" href="../wp-json/wp/v2/pages/3404.json" />
    <link rel="EditURI" type="application/rsd+xml" title="RSD" href="../../xmlrpc0db0.php?rsd" />
    <link rel="wlwmanifest" type="application/wlwmanifest+xml" href="../../wp-includes/wlwmanifest.xml" />
    <meta name="generator" content="WordPress 6.2.2" />
    <link rel="canonical" href="index.html" />
    <link rel='shortlink' href='../../indexf3ac.html?p=3404' />
    <link rel="alternate" type="application/json+oembed"
        href="../wp-json/oembed/1.0/embedcc93.json?url=https%3A%2F%2Fitcareerinstitute.org%2Findex.php%2Fform%2F" />
    <link rel="alternate" type="text/xml+oembed"
        href="../wp-json/oembed/1.0/embed4217?url=https%3A%2F%2Fitcareerinstitute.org%2Findex.php%2Fform%2F&amp;format=xml" />
    <style type="text/css">
        .evcf7_email_sent {
            color: #46b450;
        }
...
<body
    class="page-template-default page page-id-3404 wp-custom-logo wp-embed-responsive box-layout rishi-has-blocks full-width rt-loading elementor-default elementor-kit-2430"
    ...
    <div id="main-container" class="site">
                                        ...
                                        <nav id="header-menu-1" class="header-menu-1" data-id="menu"
                                            ...
                                            <ul id="menu-primary" class="menu">
                                                ...
                                                <li id="menu-item-3413"
                                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-3413 animated-submenu current-menu-item page_item page-item-6 current_page_item">
                                                    <a href="#">
                                                        <b>STUDENT SECTION</b>
                        ...
                        <div class="cb__panel_content" data-device="mobile">
                            <nav class="mobile-menu" data-id="mobile-menu" data-type="type-1">
                                <ul id="menu-primary-1" class="">
                                    ...
                                    <li
                                        class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-3404 current_page_item menu-item-3413">
                                        <a href="index.html" aria-current="page"><B>FORM</B></a>
                                    </li>
                                    <li
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3414">
        ...
        <div class="site-content reveal_none_desktop reveal_none_tablet reveal_none_mobile" style="margin-top: -76px">
                ...
                <div class="main-content-wrapper clear" data-v-spacing="top:bottom" data-page-spacing="top:bottom">
                    ...
                    <div class="container">
                        ...
                        <form class="form-horizontal" style="margin-top: 30px;"
                            action="{{ route('studentEnquiry.store') }}" method="post">
                            @csrf
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter surname"
                                        name="admission_form" value="1" hidden>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="address" placeholder="Enter address">{{ old('addresss') }}</textarea>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="email">Student Education</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="education"
                                        placeholder="Enter Education" value="{{ old('education') }}">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="email">Select Center</label>
                                <div class="col-sm-10">
                                    <select class="form-control" id="state-dropdown" name="branch_id">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="email">Select Course </label>
                                <div class="col-sm-10">
                                    <select class="form-control" id="state-dropdown" name="course_id">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="email">Please Payment First For Secure Your Seat (Pay Only 200/-  Rs)</label>
                                <div class="col-sm-10">
                                    <img src="qr/qr.png" alt="..." class="img-thumbnail" width="200" height="200">
                                     <input type="text" class="form-control" name="trx_no"
                                        placeholder="Enter Transaction Number" value="{{ old('trx_no') }}" required>
                                </div>
                            </div>
    ...
    <script id='rishi__cb_main-js-extra'>
        ...
        var rishi_custom = {
            ...
            "startPage": "1",
            "maxPages": "0",
            "nextLink": "https:\/\/itcareerinstitute.org\/index.php\/form\/page\/2\/",
            "autoLoad": "numbered",
            "bp_layout": "classic",
            "rtl": ""
        };
...
<!-- Mirrored from itcareerinstitute.org/index.php/form/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jun 2023 17:44:09 GMT -->

</html>

<!-- Page generated by LiteSpeed Cache 5.4 on 2023-06-12 17:43:02 -->
