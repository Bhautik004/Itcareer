...
<head itemscope="" itemtype="http://schema.org/WebSite">
    ...
    <link rel="stylesheet" href="{{asset('assets/js/gallery.css')}}">
        ...
        <div class="row">
            ...
            @foreach ($gallery as $img)    
                <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe">
                    {{-- <img src="{{asset('gallarry_img/{{$img}}')}}" class="img-responsive"> --}}
                    <img src="{{asset("gallery_img/$img->img_name")}}" class="img-responsive" height="365" width="365">
