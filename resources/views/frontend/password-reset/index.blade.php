...
<!-- Mirrored from itcareerinstitute.org/index.php/password-reset/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jun 2023 17:45:07 GMT -->
<!-- Added by HTTrack -->
...
<head itemscope="" itemtype="http://schema.org/WebSite">
    ...
    <title>Password Reset &#8211; IT CAREER INSTITUTE</title>
    ...
    <link rel="alternate" type="application/json" href="../wp-json/wp/v2/pages/3371.json" />
    <link rel="EditURI" type="application/rsd+xml" title="RSD" href="../../xmlrpc0db0.php?rsd" />
    <link rel="wlwmanifest" type="application/wlwmanifest+xml" href="../../wp-includes/wlwmanifest.xml" />
    <meta name="generator" content="WordPress 6.2.2" />
    <link rel="canonical" href="index.html" />
    <link rel='shortlink' href='../../indexff0a.html?p=3371' />
    <link rel="alternate" type="application/json+oembed"
        href="../wp-json/oembed/1.0/embedbdff.json?url=https%3A%2F%2Fitcareerinstitute.org%2Findex.php%2Fpassword-reset%2F" />
    <link rel="alternate" type="text/xml+oembed"
        href="../wp-json/oembed/1.0/embedb7e4?url=https%3A%2F%2Fitcareerinstitute.org%2Findex.php%2Fpassword-reset%2F&amp;format=xml" />
    <style type="text/css">
        .evcf7_email_sent {
            color: #46b450;
        }
...
<body
    class="page-template-default page page-id-3371 wp-custom-logo wp-embed-responsive um-page-password-reset um-page-loggedout box-layout rishi-has-blocks full-width rt-loading elementor-default elementor-kit-2430"
                    ...
                    <main id="primary" class="site-main">
                        <div class="rishi-container-wrap">
                            ...
                            <article id="post-3371"
                                class="post-3371 page type-page status-publish hentry rishi-post no-post-thumbnail">
                                    ...
                                    <div class="um um-password um-um_password_id">
                                        <div class="um-form">
                                            <form method="post" action="#">
                                                ...
                                                <input type="hidden" name="_um_password_reset"
                                                    id="_um_password_reset" value="1" />
                                                ...
                                                <div id="um_field_um_password_id_username_b"
                                                    class="um-field um-field-text  um-field-username_b um-field-text um-field-type_text"
                                                    data-key="username_b">
                                                    <div class="um-field-area"><input autocomplete="off"
                                                            class="um-form-field valid " type="text"
                                                            name="username_b" id="username_b" value=""
                                                            placeholder="Enter your username or email"
                                                            data-validate="" data-key="username_b" />
                                                ...
                                                <div class="um-col-alt um-col-alt-b">
                                                    ...
                                                    <div class="um-center">
                                                        <input type="submit" value="Reset password"
                                                            class="um-button" id="um-submit-btn" />
                                                    </div>
                                                ...
                                                <input type="hidden" name="form_id" id="form_id_um_password_id"
                                                    value="um_password_id" />

                                                <p class="um_request_name">
                                                    <label for="um_request_um_password_id">Only fill in if you are not
                                                        human</label>
                                                    <input type="hidden" name="um_request"
                                                        id="um_request_um_password_id" class="input" value=""
    ...
    <script id='rishi__cb_main-js-extra'>
        ...
        var rishi_custom = {
            ...
            "startPage": "1",
            "maxPages": "0",
            "nextLink": "https:\/\/itcareerinstitute.org\/index.php\/password-reset\/page\/2\/",
            "autoLoad": "numbered",
            "bp_layout": "classic",
            "rtl": ""
        };
...
<!-- Mirrored from itcareerinstitute.org/index.php/password-reset/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jun 2023 17:45:08 GMT -->

</html>

<!-- Page generated by LiteSpeed Cache 5.4 on 2023-06-12 17:45:08 -->
