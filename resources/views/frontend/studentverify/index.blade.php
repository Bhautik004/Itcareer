	...
	<div id="main-container" class="site">
		...
		<div class="container mt-3">
			...
			<table class="table table-bordered">
			  <tbody>
				<tr > 
					<td colspan="5" class="text-danger text-center" ><b>Please Enter Registration No And Student BirthDate For Student verification</b></td>
				</tr>
            <form method="post" action="/search">
				...
				<tr>       
				  ...
				  <td>Birth Date</td>
				  <td>
                    <input type="date" class="form-control" name="bday" id="basic-url" aria-describedby="basic-addon3" style="height: 20px;">
                </td>
				  <td><button type="submit" class="btn btn-danger" >Search Button</button></td>
				</tr>
            </form>
			  </tbody>
			</table>
        ...
        @if(isset($details))
		  ...
		  <div class="container mt-3" id="certificate_table">
			<table class="table table-borderless mt-2">
			  ...
			  <tbody class="bg-light">
				 ...
				 <tr>
					<td colspan="4">
						<a  href="{{  URL::to('/student/pdf',[ Crypt::encryptString($user->id)])}}" class="btn btn-dark">Generate Pdf 
						</a>
					</td>
				 </tr>
				<tr>
				  	<td class="col-4">Reg. No:</td>
				  	<td class="fw-bold" style="width: 0px">{{$user->register_no}}</td>
				 	<td rowspan="15"><img src="certificate_img/{{$user->photo_name}}" width="200px" height="200px" style="margin-right: 154px; margin-left: 82px;" ></td>
                	<td rowspan="15"><img src="web_img/verify_img.png" width="200px" height="200px" style="margin-right: 70px;"></td> 
                
				</tr>
				<tr>
				  <td class="col-4">Student Name:</td>
				  <td class="fw-bold">{{$user->student_name}}</td>
				</tr>
				<tr>
				  <td class="col-4">Son Of / Daughter of / wife of:</td>
				  <td class="fw-bold">{{$user->son_of_dauther_of_wife_of}}</td>
				</tr>
				<tr>
				  <td class="col-4">Course Name:</td>
				  <td class="fw-bold">{{$user->course_name}}</td>
				</tr>
				<tr>
				  <td class="col-4">Center Name :</td>
				  <td class="fw-bold">{{$user->center_name}}</td>
				</tr>
				<tr>
				  <td class="col-4">Center Address:</td>
				  <td class="fw-bold col-3">{{$user->center_address}}</td>
				</tr>
				<tr>
				  <td class="col-4">Area:</td>
				  <td class="fw-bold">{{$user->area}}</td>
				</tr>
				<tr>
				  <td class="col-4">Center District:</td>
				  <td class="fw-bold">{{$user->center_district}}</td>
				</tr>
				<tr>
				  <td class="col-4">Exam Date:</td>
				  <td class="fw-bold">{{$user->exam_date}}</td>
				</tr>
				<tr>
				  <td class="col-4">Certificate Issue:</td>
				  <td class="fw-bold">YES</td>
				</tr>
				<tr>
				  <td class="col-4">Issue Date :	</td>
				  <td class="fw-bold">{{$user->issue_date}}</td>
				</tr>
				<tr>
				  <td class="col-4">Certificate No:</td>
				  <td class="fw-bold">{{sprintf('%04d', $user->certificate_no); }}</td>
				</tr>
				<tr>
				  <td class="col-4">Grade:</td>
				  <td class="fw-bold">{{$user->grade}}</td>
				</tr>
                 @endforeach
			  </tbody>
