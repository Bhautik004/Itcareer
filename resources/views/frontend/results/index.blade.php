...
<!-- Mirrored from itcareerinstitute.org/index.php/results/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jun 2023 17:44:23 GMT -->
<!-- Added by HTTrack -->
...
<head itemscope="" itemtype="http://schema.org/WebSite">
    ...
    <title>CERTIFICATE &#8211; IT CAREER INSTITUTE</title>
    ...
    <link rel='stylesheet' id='elementor-post-2927-css'
        href='../../wp-content/uploads/elementor/css/post-29272e6c.css?ver=1686119800' media='all' />
    ...
    <link rel="alternate" type="application/json" href="../wp-json/wp/v2/pages/2927.json" />
    <link rel="EditURI" type="application/rsd+xml" title="RSD" href="../../xmlrpc0db0.php?rsd" />
    <link rel="wlwmanifest" type="application/wlwmanifest+xml" href="../../wp-includes/wlwmanifest.xml" />
    <meta name="generator" content="WordPress 6.2.2" />
    <link rel="canonical" href="index.html" />
    <link rel='shortlink' href='../../index6c46.html?p=2927' />
    <link rel="alternate" type="application/json+oembed"
        href="../wp-json/oembed/1.0/embed6ef3.json?url=https%3A%2F%2Fitcareerinstitute.org%2Findex.php%2Fresults%2F" />
    <link rel="alternate" type="text/xml+oembed"
        href="../wp-json/oembed/1.0/embed89c1?url=https%3A%2F%2Fitcareerinstitute.org%2Findex.php%2Fresults%2F&amp;format=xml" />
    <style type="text/css">
        .evcf7_email_sent {
            color: #46b450;
        }
...
<body
    class="page-template-default page page-id-2927 wp-custom-logo wp-embed-responsive box-layout rishi-has-blocks full-width rt-loading elementor-default elementor-template-full-width elementor-kit-2430 elementor-page elementor-page-2927"
            ...
            <div class="rishi-container" data-strech=none>
                <div class="main-content-wrapper clear" data-v-spacing="top:bottom" data-page-spacing="top:bottom">
                    <div data-elementor-type="wp-page" data-elementor-id="2927" class="elementor elementor-2927">
                        <section
                            class="elementor-section elementor-top-section elementor-element elementor-element-c5eb53c elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                            data-id="c5eb53c" data-element_type="section">
                            <div class="elementor-container elementor-column-gap-default">
                                <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-07b9a2b"
                                    data-id="07b9a2b" data-element_type="column">
                                    <div class="elementor-widget-wrap elementor-element-populated">
                                        <div class="elementor-element elementor-element-f623c42 elementor-widget elementor-widget-shortcode"
                                            data-id="f623c42" data-element_type="widget"
                                            data-widget_type="shortcode.default">
                                            <div class="elementor-widget-container">
                                                <div id="educare-loading">
                                                    <div class="educare-spinner"></div>
                                                </div>
                                                <div id="educare-results-body" class="educare_results">
                                                    <div id="msgs"></div>
                                                    <div class="results_form">
                                                        <form class="add_results" action="#" method="post"
                                                            id="educare_search_forms">
                                                            <div class="content">
                                                                <div class="select add-subject"></div>
                                                                <p>Regi No:</p>
                                                                <label for="Regi_No" class="labels"
                                                                    id="regi_no"></label>
                                                                <input type="text" name="Regi_No" value=""
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <select id="Year" name="Year"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <p>Currently, You don't have added any Year
                                                                                Please, <a
                                                                                    href='../../wp-logind098.html?page=educare-management&amp;Year'
                                                                ...
                                                                <button id="results_btn" class="results_button button"
                                                                    name="educare_results" type="submit">View Results
                                                                </button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            success: function(data) {
                                                                if (data.message) {
                                                                    ...
                                                                    $('#msgs').html('<div class="results_form error_notice ' + arr + '">' + data
                                                                        .message) + '</div>';
                                                                } else {
                                                            ...
                                                            error: function(data) {
                                                                $('#educare-results-body').html(data +
                                                                    '<div class="notice notice-error is-dismissible"><p>Sorry, database connection error!</p></div>'
                                                                    );
                                                            },
                                                            complete: function() {
    ...
    <script id='rishi__cb_main-js-extra'>
        ...
        var rishi_custom = {
            ...
            "startPage": "1",
            "maxPages": "0",
            "nextLink": "https:\/\/itcareerinstitute.org\/index.php\/results\/page\/2\/",
            "autoLoad": "numbered",
            "bp_layout": "classic",
            "rtl": ""
        };
    ...
    <script id='elementor-frontend-js-before'>
        var elementorFrontendConfig = {
            ...
            "post": {
                "id": 2927,
                "title": "CERTIFICATE%20%E2%80%93%20IT%20CAREER%20INSTITUTE",
                "excerpt": "",
                "featuredImage": false
            }
        };
...
<!-- Mirrored from itcareerinstitute.org/index.php/results/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jun 2023 17:44:28 GMT -->

</html>

<!-- Page generated by LiteSpeed Cache 5.4 on 2023-06-12 17:38:12 -->
