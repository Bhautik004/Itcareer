                                    ...
                                    <div data-items="">
                                        <nav id="header-menu-1" class="header-menu-1" data-id="menu"
                                            ...
                                            <ul id="menu-primary" class="menu">
                                                ...
                                                <li id="menu-item-1124" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1124 animated-submenu current-menu-item page_item page-item-6 current_page_item
                                                ">
            ...
            <div class="rishi-container" data-strech=none>
                <div class="main-content-wrapper clear" data-v-spacing="none" data-page-spacing="none">
                    <div data-elementor-type="wp-page" data-elementor-id="1122" class="elementor elementor-1122">
                        ...
                        <h4 class="elementor-heading-title elementor-size-default has-text-align-center">Explore our
                            current programs Courses</h4>
                        <div class="row">
                            <div class="col-md-10 form-group has-text-align-end"
                                style="    text-align: center;
    margin-top: 17px;
    margin-left: 6%;">
                                <label style="font-size: 20px;font-weight: bolder">Course Duration</label>
                        ...
                        @if (isset($details))
                            @foreach ($details as $course)
                                <section
                                    class="elementor-section elementor-top-section elementor-element elementor-element-6eadd97 elementor-section-boxed elementor-section-height-default elementor-section-height-default course_tile"
                                        ...
                                        <div class="elementor-column elementor-col-66 elementor-top-column elementor-element elementor-element-a952c69"
                                            ...
                                            <div class="elementor-widget-wrap elementor-element-populated">
                                                ...
                                                <div class="elementor-element elementor-element-75fb61f elementor-widget elementor-widget-heading"
                                                    ...
                                                    <div class="elementor-widget-container">
                                                        <h5 class="elementor-heading-title elementor-size-default"
                                                            style="border-style: dotted none dotted none; display: flex">
                                                            <label
                                                                style="padding-left: 500px; font-size: 20px;">Duration
                                                ...
                                                <p>
                                                    ...
                                                    <strong>Any More….</strong>
                                                </p>
                                                <img src="course_img/{{$course->course_img}}" alt="" srcset="" width="300px">
                                                    ...
                                                    <div class="elementor-widget-container" style="display: flex;">
                                                        ...
                                                        <img src="course_img/{{ $course->course_img }}"
                                                            alt="" srcset="" width="500px">
                                                    </div>
                                                </div>
                            ...
                            @endforeach
                        @else
                            <p class="text-danger text-center" id="notice"><b>No Record Found</b></p>
                        @endif
            ...
            $('#duration').change(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('.course_tile').css('display', 'none');
                        $('#show_course').html(data.html);
                    }
                });
            });
        })
