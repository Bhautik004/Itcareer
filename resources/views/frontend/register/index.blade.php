...
<!-- Mirrored from itcareerinstitute.org/index.php/register/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jun 2023 17:45:01 GMT -->
<!-- Added by HTTrack -->
...
<head itemscope="" itemtype="http://schema.org/WebSite">
    ...
    <title>Register &#8211; IT CAREER INSTITUTE</title>
    ...
    <link rel="alternate" type="application/json" href="../wp-json/wp/v2/pages/3367.json" />
    <link rel="EditURI" type="application/rsd+xml" title="RSD" href="../../xmlrpc0db0.php?rsd" />
    <link rel="wlwmanifest" type="application/wlwmanifest+xml" href="../../wp-includes/wlwmanifest.xml" />
    <meta name="generator" content="WordPress 6.2.2" />
    <link rel="canonical" href="index.html" />
    <link rel='shortlink' href='../../indexe4fa.html?p=3367' />
    <link rel="alternate" type="application/json+oembed"
        href="../wp-json/oembed/1.0/embedf988.json?url=https%3A%2F%2Fitcareerinstitute.org%2Findex.php%2Fregister%2F" />
    <link rel="alternate" type="text/xml+oembed"
        href="../wp-json/oembed/1.0/embeded4f?url=https%3A%2F%2Fitcareerinstitute.org%2Findex.php%2Fregister%2F&amp;format=xml" />
    <style type="text/css">
        .evcf7_email_sent {
            color: #46b450;
        }
...
<body
    class="page-template-default page page-id-3367 wp-custom-logo wp-embed-responsive um-page-register um-page-loggedout box-layout rishi-has-blocks full-width rt-loading elementor-default elementor-kit-2430"
                    ...
                    <main id="primary" class="site-main">
                        <div class="rishi-container-wrap">
                            ...
                            <article id="post-3367"
                                class="post-3367 page type-page status-publish hentry rishi-post no-post-thumbnail">
                                ...
                                <div class="entry-content" itemprop="text">
                                    ...
                                    <div class="um um-register um-3361">
                                        ...
                                        <div class="um-form" data-mode="register">
                                            ...
                                            <form method="post" action="#">
                                                ...
                                                <div class="um-row _um_row_1 " style="margin: 0 0 30px 0;">
                                                    <div class="um-col-1">
                                                        <div id="um_field_3361_user_login"
                                                            class="um-field um-field-text  um-field-user_login um-field-text um-field-type_text"
                                                            data-key="user_login">
                                                            <div class="um-field-label"><label
                                                                    for="user_login-3361">Username</label>
                                                                <div class="um-clear"></div>
                                                            </div>
                                                            <div class="um-field-area"><input autocomplete="off"
                                                                    class="um-form-field valid " type="text"
                                                                    name="user_login-3361" id="user_login-3361"
                                                                    value="" placeholder=""
                                                        ...
                                                        <div id="um_field_3361_first_name"
                                                            class="um-field um-field-text  um-field-first_name um-field-text um-field-type_text"
                                                            data-key="first_name">
                                                            <div class="um-field-label"><label
                                                                    for="first_name-3361">First Name</label>
                                                                <div class="um-clear"></div>
                                                            </div>
                                                            <div class="um-field-area"><input autocomplete="off"
                                                                    class="um-form-field valid " type="text"
                                                                    name="first_name-3361" id="first_name-3361"
                                                                    value="" placeholder="" data-validate=""
                                                                    data-key="first_name" />

                                                            </div>
                                                        </div>
                                                        <div id="um_field_3361_last_name"
                                                            class="um-field um-field-text  um-field-last_name um-field-text um-field-type_text"
                                                            data-key="last_name">
                                                            <div class="um-field-label"><label
                                                                    for="last_name-3361">Last
                                                                    Name</label>
                                                                <div class="um-clear"></div>
                                                            </div>
                                                            <div class="um-field-area"><input autocomplete="off"
                                                                    class="um-form-field valid " type="text"
                                                                    name="last_name-3361" id="last_name-3361"
                                                                    value="" placeholder="" data-validate=""
                                                                    data-key="last_name" />

                                                            </div>
                                                        </div>
                                                        <div id="um_field_3361_user_email"
                                                            class="um-field um-field-text  um-field-user_email um-field-text um-field-type_text"
                                                            data-key="user_email">
                                                            <div class="um-field-label"><label
                                                                    for="user_email-3361">E-mail Address</label>
                                                                <div class="um-clear"></div>
                                                            </div>
                                                            <div class="um-field-area"><input autocomplete="off"
                                                                    class="um-form-field valid " type="text"
                                                                    name="user_email-3361" id="user_email-3361"
                                                                    value="" placeholder=""
                                                        ...
                                                        <div id="um_field_3361_user_password"
                                                            class="um-field um-field-password  um-field-user_password um-field-password um-field-type_password"
                                                            data-key="user_password">
                                                            <div class="um-field-label"><label
                                                                    for="user_password-3361">Password</label>
                                                                <div class="um-clear"></div>
                                                            </div>
                                                            <div class="um-field-area"><input
                                                                    class="um-form-field valid " type="password"
                                                                    name="user_password-3361" id="user_password-3361"
                                                                    value="" placeholder="" data-validate=""
                                                                    data-key="user_password" />

                                                            </div>
                                                        </div>
                                                        <div id="um_field_3361_confirm_user_password"
                                                            class="um-field um-field-password  um-field-user_password um-field-password um-field-type_password"
                                                            data-key="confirm_user_password">
                                                            <div class="um-field-label"><label
                                                                    for="confirm_user_password-3361">Confirm
                                                                    Password</label>
                                                                <div class="um-clear"></div>
                                                            </div>
                                                            <div class="um-field-area"><input
                                                                    class="um-form-field valid " type="password"
                                                                    name="confirm_user_password-3361"
                                                                    id="confirm_user_password-3361" value=""
                                                                    placeholder="Confirm Password" data-validate=""
                                                                    data-key="confirm_user_password" /></div>
                                                        </div>
                                                    </div>
                                                </div> <input type="hidden" name="form_id" id="form_id_3361"
                                                    value="3361" />

                                                <p class="um_request_name">
                                                    <label for="um_request_3361">Only fill in if you are not
                                                        human</label>
                                                    <input type="hidden" name="um_request" id="um_request_3361"
                                                        class="input" value="" size="25"
                                                        autocomplete="off" />
                                                </p>

                                                <input type="hidden" id="_wpnonce" name="_wpnonce"
                                                    value="f3e50b5567" /><input type="hidden"
                                                    name="_wp_http_referer" value="/index.php/register/" />
                                                <div class="um-col-alt">


                                                    <div class="um-left um-half">
                                                        <input type="submit" value="Register" class="um-button"
                                                            id="um-submit-btn" />
                                                    </div>
                                                    <div class="um-right um-half">
                                                        <a href="../login/index.html" class="um-button um-alt">
                                                            Login </a>
                                                    </div>
    ...
    <script id='rishi__cb_main-js-extra'>
        ...
        var rishi_custom = {
            ...
            "startPage": "1",
            "maxPages": "0",
            "nextLink": "https:\/\/itcareerinstitute.org\/index.php\/register\/page\/2\/",
            "autoLoad": "numbered",
            "bp_layout": "classic",
            "rtl": ""
        };
...
<!-- Mirrored from itcareerinstitute.org/index.php/register/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jun 2023 17:45:03 GMT -->

</html>

<!-- Page generated by LiteSpeed Cache 5.4 on 2023-06-12 17:44:55 -->
