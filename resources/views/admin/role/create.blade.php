                                        ...
                                        <div class="col-4">
                                            <div class="card card-primary">
                                                <div class="card-header bg-info">
                                                    ...
                                                    <div class="float-right">
                                                        <input type="checkbox" name="permission" class="selectChildAllMaster selectChildAll" data-id="{{$acl_permissions['id']}}">
                                                ...
                                                <div class="card-body">
                                                    <div class="">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input childInputMaster childInput childCheckBox{{$methods['resources_id']}}" name="permission_id[]" type="checkbox" value="{{$methods['id']}}" data-id="{{$methods['resources_id']}}">
