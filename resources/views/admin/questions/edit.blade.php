        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="post" action="{{ route('questions.update',$questions->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" name="course_id">
                                            ...
                                            <option value="{{$course->id}}" {{ $questions->course_id == $course->id ? 'selected' : '' }}>{{$course->name}}</option>
                                            @endforeach
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="question"
                                            value="{{ $questions->question }}" placeholder="Enter Question" >
