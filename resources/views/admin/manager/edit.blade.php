                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Update Manager</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="post" action="{{ route('managers.update',$manager->id) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="f_name" class="form-control"
                                                value="{{ $manager->f_name }}" placeholder="Enter first name">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="m_name"
                                                value="{{ $manager->m_name }}" placeholder="Enter middle name">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="l_name"
                                                value="{{ $manager->l_name }}" placeholder="Enter last name">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="email"
                                                value="{{ $manager->email }}" placeholder="Enter email id">
                                            @if ($errors->has('email'))
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="phone"
                                                value="{{ $manager->phone }}" placeholder="Enter phone no.">
                                            @if ($errors->has('phone'))
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="alter_phone"
                                                value="{{ $manager->alter_phone }}" placeholder="Enter Alter phone no.">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" name="gender">
                                                ...
                                                <option value="m"  {{ $manager->gender == 'm' ? 'selected' : '' }} >Male
                                                </option>
                                                <option value="f"  {{ $manager->gender == 'f' ? 'selected' : '' }}>Female
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="dob" data-target-input="nearest">
                                                <input type="text" name="dob" value="{{ $manager->dob }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" placeholder="Enter address" name="address">{{ $manager->address }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" name="state" id="state-dropdown">
                                                ...
                                                @foreach ($states as $state) 
                                                    <option value="{{$state->id}}" {{ $manager->state == $state->id ? 'selected' : '' }} >{{$state->name}}</option>
                                                @endforeach
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="pincode"
                                                value="{{ $manager->pincode }}" placeholder="Enter PinCode">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{route('managers.index')}}"  class="btn btn-secondary bg-secondary">Cancel</a>
