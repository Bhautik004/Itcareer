...
<?php
    $count = 0;
    $studentAdmissionCreate = check_permission('studentAdmission','create');
    $studentAdmissionEdit = check_permission('studentAdmission','edit');
    $studentAdmissionDelete = check_permission('studentAdmission','destroy');
?>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Student Admission List</h3>
